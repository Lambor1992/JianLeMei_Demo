...
public class BloodViscosiyActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xuenian);
        initView();
    ...
    public void updateProgress() {
        ...
        if (progress >= 200) {
            ...
            intent.setClass(BloodViscosiyActivity.this, BloodViscosityResultActivity.class);
    ...
    private void updateChart() {
        if (flag == 1) {
            ...
            if (gx < 200) {
                if (hua[20] > 1) {
                    flags = false;
                    Toast.makeText(BloodViscosiyActivity.this, "请用您的手指同时盖住摄像头和闪光灯！",
