...
public class BloodPressActivity extends Activity implements View.OnClickListener {
    // 曲线
    ...
    private static int highRate;
    private static float bloodN;
    private static int lowRate;
    ...
    private RoundProgressBar mRoundProgressBar2,
            mRoundProgressBar5;
    private static TextView txt_ProgressBar2,
            txt_ProgressBar5;
    ...
    private void initView() {
        this.findViewById(R.id.txt_check_back).setOnClickListener(this);
    ...
    public void updateProgress() {
        ...
        if (progress >= 200) {
            ...
            intent.setClass(BloodPressActivity.this, BloodPressResultActivity.class);
    ...
    private void updateChart() {
        if (flag == 1) {
            ...
            if (gx < 200) {
                if (hua[20] > 1) {
                    flags = false;
                    Toast.makeText(BloodPressActivity.this, "请用您的手指同时盖住摄像头和闪光灯！",
