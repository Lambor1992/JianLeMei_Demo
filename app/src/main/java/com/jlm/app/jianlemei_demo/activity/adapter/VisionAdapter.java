...
public class VisionAdapter extends BaseAdapter{
    ...
    ArrayList<VisionBean> list = new ArrayList<>();
    Context context;
    ...
    public void setData(ArrayList<VisionBean> list) {
        this.list = list;
    ...
    @Override
    public VisionBean getItem(int position) {
    ...
    class ViewHolder {
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        helper.getDao(VisionBean.class).delete(visionBean);
        ...
        public void setView(VisionBean bean) {
            ...
            this.Bloodviscosity.setText("视力:" + bean.getVision());

        }

        public String bloodPressException() {
            float count = visionBean.getVision();
            if (count > 5.0f) {
                return "极好";
            } else if (count < 4.0f) {
                return "近视";
