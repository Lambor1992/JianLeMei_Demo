...
public class Geofence implements OnClickListener {
    ...
    protected static void addEntity() {
        // entity标识
        String Hi = MyTrackActivity.Hi;
        // 属性名称（格式 : "key1=value1,columnKey2=columnValue2......."）
        String columnKey = "name=testName";
        MyTrackActivity.client.addEntity(MyTrackActivity.serviceId, Hi, columnKey, MyTrackActivity.entityListener);
    }
    ...
    private void createFence() {
        ...
        // 创建者（entity标识）
        String creator = MyTrackActivity.Hi;
        // 围栏名称
        String fenceName = MyTrackActivity.Hi + "_fence";
        // 围栏描述
        String fenceDesc = "test";
        // 监控对象列表（多个Hi，以英文逗号"," 分割）
        String monitoredPersons = MyTrackActivity.Hi;
        // 观察者列表（多个Hi，以英文逗号"," 分割）
        String observers = MyTrackActivity.Hi;
        // 生效时间列表
        ...
        MyTrackActivity.client.createCircularFence(MyTrackActivity.serviceId, creator, fenceName, fenceDesc,
    ...
    private static void deleteFence(int fenceId) {
        MyTrackActivity.client.deleteFence(MyTrackActivity.serviceId, fenceId, geoFenceListener);
    }
    ...
    private void updateFence() {
        ...
        MyTrackActivity.client.updateCircularFence(MyTrackActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons,
    ...
    protected static void queryFenceList() {
        ...
        // 围栏ID列表
        String fenceIds = "";
        MyTrackActivity.client.queryFenceList(MyTrackActivity.serviceId, creator, fenceIds, geoFenceListener);
    }
    ...
    private void monitoredStatus() {
        ...
        // 监控对象列表（多个Hi，以英文逗号"," 分割）
        String monitoredPersons = MyTrackActivity.Hi;
        MyTrackActivity.client.queryMonitoredStatus(MyTrackActivity.serviceId, fenceId, monitoredPersons,
                geoFenceListener);
    }
    ...
    // int fenceId = Geofence.fenceId;
    // // 监控对象列表（多个Hi，以英文逗号"," 分割）
    // String monitoredPersons = MainActivity.Hi;
    ...
    private void historyAlarm() {
        ...
        MyTrackActivity.client.queryFenceHistoryAlarmInfo(MyTrackActivity.serviceId, fenceId, monitoredPersons, beginTime,
                endTime,
                geoFenceListener);
    }
    ...
    private void delayAlarm() {
        ...
        int fenceId = Geofence.fenceId;
        // 观察者列表（多个Hi，以英文逗号"," 分割）
        String observer = MyTrackActivity.Hi;
        // 延迟时间（unix时间戳）
        int delayTime = (int) (System.currentTimeMillis() / 1000 + this.delayTime * 60);
        MyTrackActivity.client.delayFenceAlarm(MyTrackActivity.serviceId, fenceId, observer, delayTime,
                geoFenceListener);
    }
    ...
    public void onClick(View v) {
        ...
        // 设置围栏
            case R.id.btn_setfence:
                inputDialog();
                MyTrackActivity.mBaiduMap.setOnMapClickListener(mapClickListener);
    ...
    private void initOnGeoFenceListener() {
        ...
        geoFenceListener = new OnGeoFenceListener() {
            ...
            public void onRequestFailedCallback(String arg0) {
                ...
                Toast.makeText(MyTrackActivity.mContext, "geoFence请求失败回调接口消息 : " + arg0, Toast.LENGTH_LONG).show();
        ...
        builder.setTitle("围栏半径(单位:米)").setView(circleRadius)
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO Auto-generated method stub
                        MyTrackActivity.mBaiduMap.setOnMapClickListener(null);
                    }
