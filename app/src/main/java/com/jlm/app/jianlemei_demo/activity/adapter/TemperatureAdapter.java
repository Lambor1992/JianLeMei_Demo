...
public class TemperatureAdapter extends BaseAdapter{
    ...
    ArrayList<TemperatureBean> list = new ArrayList<>();
    Context context;
    ...
    public void setData(ArrayList<TemperatureBean> list) {
        this.list = list;
    ...
    @Override
    public TemperatureBean getItem(int position) {
    ...
    class ViewHolder {
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        helper.getDao(TemperatureBean.class).delete(Bean);
        ...
        public void setView(TemperatureBean bean) {
            ...
            this.Bloodviscosity.setText("体温:" + bean.getTemperature());

        }

        public String bloodPressException() {
            float count = Bean.getTemperature();
            if (count > 37.4f) {
                return "偏高";
            } else if (count < 36f) {
                return "偏低";
