...
@SuppressLint("NewApi")
public class MyTrackActivity extends FragmentActivity implements OnClickListener {
     ...
     * entity标识
     */
    protected static String Hi = null;

    /**
     * 鹰眼服务ID，开发者创建的鹰眼服务对应的服务ID
     */
    protected static long serviceId = 116062;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化轨迹服务
        trace = new Trace(getApplicationContext(), serviceId, Hi, traceType);
