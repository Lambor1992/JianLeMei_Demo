...
public class OxygenActivity extends Activity implements View.OnClickListener {
    ...
    private static TextView txt_ProgressBar4;
    ...
    public void updateProgress() {
        ...
        if (progress >= 200) {
            ...
            intent.setClass(OxygenActivity.this, OxygenResultActivity.class);
    ...
    private void updateChart() {
        if (flag == 1) {
            ...
            if (gx < 200) {
                if (hua[20] > 1) {
                    flags = false;
                    Toast.makeText(OxygenActivity.this, "请用您的手指同时盖住摄像头和闪光灯！",
