...
public class HeartRateActivity extends Activity implements View.OnClickListener {
    ...
    private static TextView txt_ProgressBar1;
    ...
    public void updateProgress() {
        ...
        if (progress >= 200) {
            ...
            intent.setClass(HeartRateActivity.this, HeartRateResultActivity.class);
    ...
    private void updateChart() {
        if (flag == 1) {
            ...
            if (gx < 200) {
                if (hua[20] > 1) {
                    flags = false;
                    Toast.makeText(HeartRateActivity.this, "请用您的手指同时盖住摄像头和闪光灯！",
