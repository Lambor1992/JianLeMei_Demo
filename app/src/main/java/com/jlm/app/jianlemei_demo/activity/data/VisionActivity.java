...
import com.jlm.app.jianlemei_demo.activity.adapter.VisionAdapter;
...
public class VisionActivity extends Activity {
    ...
    private void initView() {
        Title.setTitleName("视力检测");
        NameTv.setText("视力");
        VisionAdapter adapter = new VisionAdapter(this);
        mListview.setAdapter(adapter);
        ExamSQLHelper examSQLHelper = new ExamSQLHelper(this);
        try {
            ArrayList<VisionBean> xList = (ArrayList<VisionBean>) examSQLHelper.getDao(VisionBean.class).queryForAll();
    ...
    private void initChartView(ArrayList<VisionBean> list) {
        ...
        for (int i = 0; i < numColumns; i++) {
            ...
            values.add(new SubcolumnValue(list.get(i).getVision(), Color.parseColor("#f237e3")));
