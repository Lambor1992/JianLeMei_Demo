...
public class OxygenAdapter extends BaseAdapter {
    ...
    ArrayList<OxygenBean> list = new ArrayList<>();
    Context context;
    ...
    public void setData(ArrayList<OxygenBean> list) {
        this.list = list;
    ...
    @Override
    public OxygenBean getItem(int position) {
    ...
    class ViewHolder {
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        helper.getDao(OxygenBean.class).delete(oxygenBean);
        ...
        public void setView(OxygenBean bean) {
            ...
            this.Bloodviscosity.setText("血氧:" + bean.getOxygen());

        }

        public String bloodPressException() {
            float count = oxygenBean.getOxygen();
            if (count > 1f) {
                return "偏高";
            } else if (count < 0f) {
                return "偏低";
