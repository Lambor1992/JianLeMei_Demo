            ...
            public void run() {
                ...
                while (isCheck) {
                    ...
                    if (!isServiceWork(getApplicationContext(), SERVICE_NAME)) {
                        ...
                        if (null != MyTrackActivity.client && null != MyTrackActivity.trace) {
                            MyTrackActivity.client.startTrace(MyTrackActivity.trace);
                        } else {
                            MyTrackActivity.client = null;
                            MyTrackActivity.client = new LBSTraceClient(getApplicationContext());
                            MyTrackActivity.Hi = MyTrackActivity.getImei(getApplicationContext());
                            MyTrackActivity.trace = new Trace(getApplicationContext(), MyTrackActivity.serviceId,
                                    MyTrackActivity.Hi);
                            MyTrackActivity.client.startTrace(MyTrackActivity.trace);
                        }
